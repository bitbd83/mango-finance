...
import { Button, Flex, Image, Link } from '@mangofarm/uikit'
import { communityFarms } from 'config/constants'
import { Farm } from 'state/types'
import { usePriceBnbBusd, usePriceMangoBusd } from 'state/hooks'
...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed }) => {
  ...
  // We assume the token name is coin pair + lp e.g. MANGO-BNB LP, BUSD-BNB LP,
  ...
  return (
    <FCard>
      ...
      <Label>
        ...
        <span className="right">{farm.dual ? farm.dual.earnLabel : 'MANGO'}</span>
      </Label>
      {!removed && (
        <Label>
