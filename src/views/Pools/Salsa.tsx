...
import { BLOCKS_PER_YEAR, MANGO_PER_BLOCK } from 'config'
...
const Farm: React.FC = () => {
  ...
  const poolsWithApy = pools.map((pool) => {
    ...
    const totalRewardPricePerYear = rewardTokenPriceInBNB.times(MANGO_PER_BLOCK).times(pool.tokenPerBlock).times(BLOCKS_PER_YEAR)
      ...
      <Hero>
        <div>
          ...
          <Heading as="h4" size="l" mb="14px">
            {TranslateString(282, 'MANGO Smart Staking Pool')}
          </Heading>
          <Heading as="h4" size="l" mb="14px">
            {TranslateString(282, 'CAUTION!!! PLEASE DO NOT SELL / MOVE YOUR EARNED #JUICE TOKEN. YOUR TRANSACTION MAY REVERT THEN.')}
          </Heading>
          <ul>
            <li>{TranslateString(580, 'Stake MANGO or supported tokens to earn')}</li>
